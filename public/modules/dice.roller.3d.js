...
function roll(type, options = true) {
  ...
  function animate(time) {
    ...
    if (cinematic) {
      die.position.z = THREE.MathUtils.lerp(startZ, targetZ, easeOutCubic(t));
      die.position.x = THREE.MathUtils.lerp(startX, targetX, t);
    } else {
...
export const Dice3D = {
  ...
  roll(type = 'd20', arg = true) {
    ...
    if (String(type).toLowerCase() === 'd100') {
      ...
      roll(type, { cinematic, rng, targetValue: value, targetClient });
    }
